  ...
  computed: {
    ...
    selectedNodes: function selectedNodes() {
      ...
      return this.multipleValue.map(function (value) {
        var option = _this3.findOption(value);
        return h(
          _Label2.default,
          {
            nativeOn: {
  ...
  render: function render() {
    ...
    return h(
      ...
      (0, _babelHelperVueJsxMergeProps2.default)([{
        ...
        'class': this.classes('ui', this.button && 'button', this.floating && 'floating', this.fluid && 'fluid', this.labeled && 'labeled', this.multiple && 'multiple', this.selection && 'selection', this.search && 'search', this.open && 'active visible', !this.downward && directions.upward, 'dropdown')
      }, {
        on: eventHandlers,
        nativeOn: eventHandlers
      }]),
      [this.selectedNodes, this.searchNode, this.textNode, h(
        'i',
